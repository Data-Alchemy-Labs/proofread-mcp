...
export const INSTRUCTIONS =
  ...
  "For US law it takes a sentence that states a rule and lists up to 3 cases whose own text states it, each with the passage it matched; " +
  "this is a beta, so repeat its beta line to the user. " +
  "A suggestion is a case to read before citing it; check_citations checks citations. " +
